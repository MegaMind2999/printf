...
/**
 * write_the_number - Printing a string
 * @is_negative: args
 * @ind: char types.
 * @buffer: buffer to be used in printing
 * @flags:  the active flags
 ...
 * Return: count of the chars printed.
 */
int write_the_number(int is_negative, int ind, char buffer[],
	int flags, int width, int precision, int size)
{
	...
	return (write_mynum(ind, buffer, flags, width, precision,
		length, padd, extra_ch));
}

/**
 * write_mynum - Write a number using a bufffer
 ...
 */
int write_mynum(int ind, char buffer[],
...
/**
 * write_unsignd - Writes an unsigned
...
/**
 * write_the_ptr - Writing a memory address
